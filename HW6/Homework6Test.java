package HW6;/* Homework6Test.java */
...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // from here.
    System.out.println("number of buckets is "+table.capacity()+",number of entries is "+table.size());
    System.out.println("Expect collision:"+table.collision());
    System.out.println("Real collision:"+table.collision);
