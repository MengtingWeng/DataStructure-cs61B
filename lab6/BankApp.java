package lab6;/* BankApp.java */

import lab6.sortedlist.BadTransactionException;
...
public class BankApp {
  ...
  */
   ...
   *  @exception IOException if there are problems reading user input.
   */
  private void doWithdraw() throws IOException, BadTransactionException, BadAccountException {
    // Get account number.
    int acctNumber = readInt("Enter account number: ");
